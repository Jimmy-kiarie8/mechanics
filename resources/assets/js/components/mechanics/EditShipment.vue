        ...
        <v-container grid-list-md>
          <v-layout wrap>
            <v-form ref="form" @submit.prevent="submit">
              ...
              <select class="custom-select custom-select-sm col-md-3" v-model="list.insuarance_status">
                <option selected>Insurance Status</option>
                <option value="yes">Yes</option>
                <option value="no">No</option>
              </select>
              <select class="custom-select custom-select-sm col-md-3" v-model="list.payment">
